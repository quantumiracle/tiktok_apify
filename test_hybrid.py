"""
Test script for the hybrid TikTok parser approach
"""
...
def main():
    ...
    topic_processor = TopicProcessor(api_client, results_per_hashtag=20)  # Limit to 20 for testing
    ...
    # Step 1: Get profiles from topic using TikTok Scraper API
    ...
    # Step 2: Get detailed profile data using TikTok Profile Scraper API
    print(f"Getting detailed profile data for: {usernames_list}")
    ...
    # Export results
    data_exporter.export_data(filtered_profiles, "hybrid_results", "csv")
    data_exporter.export_data(filtered_profiles, "hybrid_results", "json")
    
    print(f"\nResults exported to {output_dir}/hybrid_results.csv and {output_dir}/hybrid_results.json")
